...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 Ctrl_PS W 0x0 "Data signal of Ctrl_PS" {{0 32 Ctrl_PS W 0 "Bit 31 to 0 Data signal of Ctrl_PS"}}} {0x18 FifoByteNum_PS W 0x0 "Data signal of FifoByteNum_PS" {{0 32 FifoByteNum_PS W 0 "Bit 31 to 0 Data signal of FifoByteNum_PS"}}} {0x20 StringUpdate R 0x0 "Data signal of StringUpdate" {{0 32 StringUpdate R 0 "Bit 31 to 0 Data signal of StringUpdate"}}} {0x24 StringUpdate_ctrl R 0x0 "Control signal of StringUpdate" {{0 1 StringUpdate_ap_vld R 0 "Control signal StringUpdate_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 StringLen R 0x0 "Data signal of StringLen" {{0 32 StringLen R 0 "Bit 31 to 0 Data signal of StringLen"}}} {0x2c StringLen_ctrl R 0x0 "Control signal of StringLen" {{0 1 StringLen_ap_vld R 0 "Control signal StringLen_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 MISO_Sel_i W 0x0 "Data signal of MISO_Sel_i" {{0 32 MISO_Sel_i W 0 "Bit 31 to 0 Data signal of MISO_Sel_i"}}} {0x38 MISO_Sel_o R 0x0 "Data signal of MISO_Sel_o" {{0 32 MISO_Sel_o R 0 "Bit 31 to 0 Data signal of MISO_Sel_o"}}} {0x3c MISO_Sel_o_ctrl R 0x0 "Control signal of MISO_Sel_o" {{0 1 MISO_Sel_o_ap_vld R 0 "Control signal MISO_Sel_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 2 II 1}
