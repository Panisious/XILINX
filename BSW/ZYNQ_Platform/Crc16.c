...
uint16 CRC16_Check_Modbus(uint8 *puchMsg, uint16 usDataLen)
{
    ...
    {
        index = crc_HI ^ *puchMsg++ ; /* calculate the CRC */
        crc_HI = crc_LO ^ ModbusCRC16_HI[index] ;
        crc_LO = ModbusCRC16_LO[index] ;
    }
